...
@objs = ["points/2d_points.o","lines/lines.o","double_linked_list/double_linked_list.o", "convex_hull/convex_hull.o"]
@cflags = "-I."
@debug = "-g"
@main = "main.o"
...
@shared = ["points/2d_points.so","lines/lines.so","double_linked_list/double_linked_list.so","convex_hull/convex_hull.so"]
@lib_dir = "lib/"
...
def compile_c
  ...
  command = "#{@cc} #{@debug} -o #{@main[0..-3]} #{objs.join(" ")} #{@cflags} -lm"
  puts "\t"+ command
